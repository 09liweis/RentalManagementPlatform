...
import { PROPERTY_ROOMS, ROOM_DETAIL } from "@/constants/apis";
...
export default function PropertyDetail({ propertyId, roomId, tenantId }: ScreenProps) {
  const { t } = useAppStore();
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        {curProperty?._id && <PropertyCard p={curProperty} />}
      </motion.div>
