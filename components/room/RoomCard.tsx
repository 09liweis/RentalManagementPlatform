...
export default function RoomCard({ room, handleEditRoom }: any) {
  ...
  return (
    <article
      className={`bg-white rounded-xl shadow-sm hover:shadow-md ${hasSelected?'p-2':'p-6'} transition-all duration-300 border ${isSelected ? "border-blue-500 hover:border-blue-800" : "border-gray-100 hover:border-gray-200"} transform hover:-translate-y-1`}
    >
