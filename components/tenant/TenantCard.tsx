...
export default function TenantCard({
  ...
  return (
    <article
      className={`bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_20px_rgba(0,0,0,0.1)] transition-all duration-300 ${hasCurTenant ? "p-2" : "p-6"} border ${isCurrent ? "border-blue-500 hover:border-blue-700" : "border-gray-100/80 hover:border-gray-200"} group`}
    >
